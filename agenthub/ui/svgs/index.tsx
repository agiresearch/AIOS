export const DatasetSVG = () => (
    <svg
      className="mr-1 text-gray-400 group-hover:text-red-500 flex-none -ml-0.5"
  ...
  export const TableViewerSVG = () => (
    ...
    >
      <path
        fill="currentColor"
        d="M2.5 2h7a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-7a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1Zm0 2v2h3V4h-3Zm4 0v2h3V4h-3Zm-4 3v2h3V7h-3Zm4 0v2h3V7h-3Z"
      ></path>
    </svg>
  )
  
  export const TablePreviewSVG = () => (
    <svg
      className="flex-none w-3 text-gray-400 mr-1"
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
  ...
  export const LanguageSVG = () => (
    <svg
      ...
      aria-hidden="true"
      role="img"
      className="ml-2 text-green-600/80"
      preserveAspectRatio="xMidYMid meet"
      width="1em"
      height="1em"
      viewBox="0 0 10 10"
